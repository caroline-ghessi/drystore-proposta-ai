...
const DivisoriasLayout: React.FC<ProposalLayoutProps> = ({
  proposal,
  proposalItems,
  selectedSolutions,
  canInteract,
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
            Sistemas de Divisórias Inteligentes
          </h2>
          <p className="text-lg text-gray-600">
            Soluções flexíveis para otimização de espaços
          </p>
        </div>
...
export default DivisoriasLayout;
