...
export const TechnicalDetails = ({ technicalDetails, technicalImages, solutions }: TechnicalDetailsProps) => {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent>
        <p className="text-gray-700 leading-relaxed mb-6">{technicalDetails}</p>
